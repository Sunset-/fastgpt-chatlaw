...
export async function dispatchModules({
  ...
  async function moduleRun(module: RunningModuleItemType): Promise<any> {
    ...
    const dispatchRes = await (async () => {
      var isChatlaw = false
      var chatNode = modules.find(item=>item.flowType=='chatNode')
      if(chatNode){
      ...
      const callbackMap: Record<string, Function> = {
        ...
        [FlowModuleTypeEnum.chatNode]: isChatlaw ? dispatchChatCompletionLocal:dispatchChatCompletion,
      ...
      console.log('module.flowType:',module.flowType)
